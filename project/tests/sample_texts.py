"""
Sample texts for testing the AI Text Summarizer.
Each text is designed to test different aspects of summarization.
"""
...
of a new era in space exploration. Upon their return, President Nixon declared, "This is the greates
week in the history of the world since the Creation."
"""

# Example usage of how to test these texts
if __name__ == "__main__":
    from summarizer import generate_summary

    print("Testing short text summarization:")
    print("-" * 50)
    try:
        summary = generate_summary(SHORT_TEXT)
        print("Original length:", len(SHORT_TEXT.split()))
